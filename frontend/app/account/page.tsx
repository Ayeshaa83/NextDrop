...
import { User, Mail, Globe, Shield, Award, Link2, CheckCircle2, AlertCircle, XCircle } from 'lucide-react';
        ...
        >
            ...
            <motion.div variants={item} className="card-premium p-10 flex flex-col items-center text-center space-y-6">
                <div className="relative">
                    ...
                    {/* Online indicator */}
                    <span className="absolute bottom-1 right-1 size-4 bg-emerald-400 rounded-full border-2 border-[#050505] shadow-lg" />
                </div>
                <div>
